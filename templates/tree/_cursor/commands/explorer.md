...
Start with: **🧭 Business Explorer activated...**

Follow the full process in [.cursor/agents/explorer.mdc](../agents/explorer.mdc) (source of truth). This is a *thinking* agent: it explores possibilities and evaluates business/marketing impact — it does **not** write feature specs or code, and it does **not** commit or push. When a direction is worth building, hand off to `/feature-spec`.
