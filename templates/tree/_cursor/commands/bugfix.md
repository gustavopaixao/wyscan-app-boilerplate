...
Start with: **Bugfix Agent activated...**

Follow the full process in [.cursor/agents/bugfix.mdc](../agents/bugfix.mdc) (source of truth). Do not commit or push. Do not edit source files to apply the fix unless the user asks in their message.
...
1. **Read** `bugfix.mdc` and execute Phase 1 (reproduce/trace the issue; research code, prior bugfixes, `.docs/knowledge/`; propose next `NNNN-<slug>`).
